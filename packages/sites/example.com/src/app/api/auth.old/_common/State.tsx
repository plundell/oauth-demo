 ...
 */
import { encrypt, decrypt } from "@local/helpers/crypto/encryption";
import { readWriteKeyPair } from "@local/helpers/crypto/keys";
import { JSONCompatible } from "@local/helpers/json";
...
export class State implements StateProperties {
     ...
     */
    constructor(referer: string, expiration: number) {
     ...
     */
    static decrypt(base64: string): State {
