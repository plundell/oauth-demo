/**
 * Handles the GET request to /api/auth/getcode
 * 
 ...
 * 
 * See also /api/auth/gettoken which handles the next and final step of the flow
 */
...
export async function GET(request: NextRequest) {
    // console.log("GET /api/auth/getcode", request);
    ...
    try {
        ...
        authUrl.searchParams.set('state', state.encrypt());
